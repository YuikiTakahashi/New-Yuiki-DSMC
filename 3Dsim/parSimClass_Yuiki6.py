...
if __name__ == '__main__':
    for flowname in [ 't010','tv2n','tv3n', 'tv10n','thalfv10n','thalfv25n']:
        simObject = ParticleTracing_Yuiki(flowFieldName='flows/X_Cell/DS2'+ flowname + '.DAT', NPAR=1000,INIT_COND=14,CORRECTION=3)
        outfile='Data/TCellTesting_inicon14 4KHe newpdf/'+ flowname + '.dat'
