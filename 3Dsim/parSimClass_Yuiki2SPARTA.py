...
class ParticleTracing_Yuiki(object):
    ...
    def __init__(self, flowFieldName='flows/F_Cell/DS2f005.DAT', NPAR=10, CROSS_MULT=1, LITE_MODE=True, INIT_COND=0, PROBE_MODE=False, CORRECTION=1):
        ...
        #modify this part - add the name of the cell geometry and position of the aperture and end position in meters  by Yuiki
...
def get_flow_chars(filename):
    ...
    #modify this part - add here the name of the cell geometry
    #also, make sure that the output filename is like FILENAME = 'flows/X_Cell/DS2xabc.DAT' Or you can maybe modify this part to more general one if you want - by Yuiki
