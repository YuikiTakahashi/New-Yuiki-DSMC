...
# Remember to set ambient flow parameters in the function definition below.
...
def ambientFlow(x, y, z, zFlow=40, xFlow=0, yFlow=0, aperture=False):
    '''
...
def pathTrace(x0=0, y0=0, z0=0, T_s0=4, aperture=False):
    '''
...
def endPosition(T_s0=4, L=0.01, aperture=True):
    '''
    ...
    '''
    global vx, vy, vz, x, y, z
    x, y, z = initial_species_position(L)
    vx, vy, vz = initial_species_velocity(T_s0)
